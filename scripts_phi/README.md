...
```
~/fastmc/scripts_phi/                    ← this directory (code, persistent)
...
```bash
/work/clas12/vpk/fast_MC/venv/bin/pip freeze > ~/fastmc/scripts_phi/requirements.txt
```
...
# work on ifarm)
/work/clas12/vpk/fast_MC/venv/bin/pip install -r ~/fastmc/scripts_phi/requirements.txt
```
